...
api_instance = my_petstore_client.StoreApi()
...
# create an instance of the API class
api_instance = my_petstore_client.StoreApi(my_petstore_client.ApiClient(configuration))
...
# create an instance of the API class
api_instance = my_petstore_client.StoreApi()
body = my_petstore_client.Order() # Order | order placed for purchasing the pet
