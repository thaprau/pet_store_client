...
api_instance = my_petstore_client.UserApi()
body = my_petstore_client.User() # User | Created user object
...
# create an instance of the API class
api_instance = my_petstore_client.UserApi()
body = [my_petstore_client.User()] # list[User] | List of user object
...
# create an instance of the API class
api_instance = my_petstore_client.UserApi()
body = my_petstore_client.User() # User | Updated user object
